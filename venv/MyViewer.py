...
class Application(tk.Frame):
    ...
    def create_widget(self):
        ...
        interaction_frame = tk.Frame(self.master, borderwidth=1, relief="solid")
        view_frame = tk.Frame(self.master, borderwidth=1, relief="solid", width=1024, height=1024)

        interaction_frame.pack(side=tk.LEFT)
        view_frame.pack()

        # Canvas
        self.canvas = tk.Canvas(view_frame, background="black", width=1024, height=1024)
    ...
    def set_image(self, filename):
        ...
        self.img_arr = np.array(self.pil_image)
    ...
    def mouse_move(self, event):
        ...
        self.label_image_pixel["text"] = (f"({event.x}, {event.y})")
